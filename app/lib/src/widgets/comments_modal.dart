...
class _CommentModalState extends State<CommentModal> {
  ...
  void initState() {
    ...
    commentProvider
        .getPostComments(widget.postId, widget.postType)
        .then((value) {
      setState(() {
        comments = value;
  ...
  Future addComment(String content) async {
    final Comment newComment = Comment(
        content: content,
        commenter: posterPerson,
        createdAt: DateTime.now(),
        postType: widget.postType);
    commentProvider.addComment(newComment, widget.postId).then((val) {
      setState(() {
        comments = val;
        comments.sort((a, b) => b.createdAt.compareTo(a.createdAt));
      });
                          ...
                          return Column(
                            children: [
                              ...
                              CommentW(
                                ...
                                userName:
                                    comments[index].commenter.fullName ?? '',
                                userImgUrl:
                                    comments[index].commenter.image ?? '',
        ...
        children: [
          const CircleAvatar(
            ...
            backgroundImage: NetworkImage(
                'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Jason_Statham_2018.jpg/330px-Jason_Statham_2018.jpg'),
          ),
